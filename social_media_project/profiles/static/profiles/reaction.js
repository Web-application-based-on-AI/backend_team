$(document).ready(function() {
    ...
    document.getElementById('time').innerHTML = (RightNow.getMonth() + "-" + RightNow.getDate() + "-" + RightNow.getYear() + RightNow.getHours() + ":" + RightNow.getMinutes() + " and " + RightNow.getSeconds() + " seconds")
});
let RightNow = new Date();
document.getElementById('time').innerHTML = (RightNow.getMonth() + "-" + RightNow.getDate() + "-" + RightNow.getYear() + RightNow.getHours() + ":" + RightNow.getMinutes() + " and " + RightNow.getSeconds() + " seconds")